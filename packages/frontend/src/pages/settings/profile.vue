		...
		<SearchMarker>
			<MkFolder>
				...
				<div class="_gaps_m">
					...
					<SearchMarker :keywords="['nocat']">
						<MkSwitch v-model="profile.isNoCat">
							<template #label><SearchLabel>{{ i18n.ts.flagAsNoCat }}</SearchLabel></template>
							<template #caption>{{ i18n.ts.flagAsNoCatDescription }}</template>
						</MkSwitch>
					</SearchMarker>

					<SearchMarker :keywords="['sheep']">
						<MkSwitch v-model="profile.isSheep">
							<template #label><SearchLabel>{{ i18n.ts.flagAsSheep }}</SearchLabel></template>
							<template #caption>{{ i18n.ts.flagAsSheepDescription }}</template>
						</MkSwitch>
					</SearchMarker>

					<SearchMarker :keywords="['dsite']">
						<MkSwitch v-model="profile.isDsite">
							<template #label><SearchLabel>{{ i18n.ts.flagAsDsite }}</SearchLabel></template>
							<template #caption>{{ i18n.ts.flagAsDsiteDescription }}</template>
						</MkSwitch>
					</SearchMarker>
