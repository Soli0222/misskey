		...
		<div :class="$style.main">
			...
			<div style="container-type: inline-size;">
				<p v-if="appearNote.cw != null" :class="$style.cw">
					<Mfm v-if="appearNote.cw != ''" style="margin-right: 8px;" :text="appearNote.cw" :author="appearNote.user" :nyaize="'account'" :myaize="'account'"/>
					...
					<div :class="$style.text">
						...
						<div v-if="translating || translation" :class="$style.translation">
							...
							<div v-else>
								...
								<Mfm :text="translation.text" :author="appearNote.user" :nyaize="'account'" :myaize="'account'" :emojiUrls="appearNote.emojis"/>
							</div>
						</div>
					</div>
