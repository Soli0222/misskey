...
>
	...
	<div v-if="renoteCollapsed" :class="$style.collapsedRenoteTarget">
		...
		<Mfm :text="getNoteSummary(appearNote)" :plain="true" :nowrap="true" :author="appearNote.user" :nyaize="'account'" :myaize="'account'" :class="$style.collapsedRenoteTargetText" @click="renoteCollapsed = false"/>
	</div>
		...
		<div :class="$style.main">
			...
			<div style="container-type: inline-size;">
				<p v-if="appearNote.cw != null" :class="$style.cw">
					<Mfm v-if="appearNote.cw != ''" style="margin-right: 8px;" :text="appearNote.cw" :author="appearNote.user" :nyaize="'account'" :myaize="'account'" :i="$i"/>
				...
				<div v-show="appearNote.cw == null || showContent" :class="[{ [$style.contentCollapsed]: collapsed }]">
					<div :class="$style.text">
						...
						<Mfm v-if="appearNote.text" :parsedNodes="parsed" :text="appearNote.text" :author="appearNote.user" :nyaize="'account'" :myaize="'account'" :i="$i" :emojiUrls="appearNote.emojis"/>
						<div v-if="translating || translation" :class="$style.translation">
							<MkLoading v-if="translating" mini/>
							<div v-else>
								<b>{{ i18n.t('translatedFrom', { x: translation.sourceLang }) }}: </b>
								<Mfm :text="translation.text" :author="appearNote.user" :nyaize="'account'" :myaize="'account'" :i="$i" :emojiUrls="appearNote.emojis"/>
							</div>
						</div>
					</div>
