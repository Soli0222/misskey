...
export interface UseNoteElements {
	...
	favButton?: Ref<HTMLElement | null>;
}
...
export function useNote(
	...
	async function checkFav(noteToCheck: Misskey.entities.Note): Promise<boolean> {
		const result = await misskeyApi('notes/state', {
			noteId: noteToCheck.id,
		});
