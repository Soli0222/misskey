	...
	<div :class="$style.main">
		...
		<div>
			<p v-if="note.cw != null" :class="$style.cw">
				<EmMfm v-if="note.cw != ''" style="margin-right: 8px;" :text="note.cw" :author="note.user" :nyaize="'respect'" :nonyaize="'respect'" :myaize="'respect'" :dlsize="'respect'" :emojiUrls="note.emojis"/>
