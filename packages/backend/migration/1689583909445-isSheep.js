export class IsSheep1689583909445 {
    name = 'IsSheep1689583909445'
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "antenna" ALTER COLUMN "lastUsedAt" SET DEFAULT '2023-07-17 08:33:14.12536+00'`);
